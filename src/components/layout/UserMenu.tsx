  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      <button
        ...
        className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-gray-muted transition-colors duration-200 hover:bg-white/5 hover:text-cream"
      >
        {user?.avatar ? (
          <img
            src={user.avatar}
          ...
          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-gpssa-green/40 to-adl-blue/40 flex items-center justify-center text-cream text-xs font-bold shrink-0">
