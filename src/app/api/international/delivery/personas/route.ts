...
export async function GET(req: NextRequest) {
  try {
    ...
    const personas = await prisma.internationalCustomerPersona.findMany({
      where,
      include: {
    ...
    const message = error instanceof Error ? error.message : "Failed to fetch international personas";
