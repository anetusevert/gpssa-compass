        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <span className="hidden sm:inline text-xs text-gray-muted">
              Tiered SLAs & underpinning OLAs
            </span>
          </div>
          <div className="flex items-center gap-2">
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] px-3 py-2">
              <p className="text-[9px] uppercase tracking-[0.16em] text-white/40">SLAs</p>
              <p className="text-sm font-semibold text-cream tabular-nums">{slas.length}</p>
            </div>
        ...
        >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-muted leading-relaxed max-w-3xl">
                  An SLA can look green outside while the customer is red inside. Pair every SLA
                  metric with a <span className="text-cream">CSAT / customer-effort outcome</span>{" "}
                  so a technically-met SLA never masks a poor experience.
                </p>
              </div>
            </div>
          </Card>
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-muted mt-3 italic max-w-3xl">
              OLA targets underpin the SLA so a supporting internal activity can never silently
              breach the customer-facing commitment.
            </p>
          </div>
        </motion.div>
      </TileScroll>
