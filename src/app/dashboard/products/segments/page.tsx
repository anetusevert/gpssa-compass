...
// Canonical Emirati labor-market spine (matches LABOR_SEGMENTS in
// src/lib/taxonomy/segments.ts). Population figures reflect the UAE labor
// force structure (UAE Federal Competitiveness & Statistics Centre 2023).
// Real coverage levels are auto-overwritten by /api/products/segments once
// the products-segments agent runs; this is just the pre-fetch fallback.
const STATIC_SEGMENT_MATRIX: SegmentRow[] = [
  { id: "national-formal",        name: "National — Formal Employment",     detail: "Emirati nationals in public or private formal employment.",                  populationLabel: "~0.6M", populationM: 0.6, cells: defaultCells({ "Retirement Coverage": "Covered", "Occupational Hazard": "Covered", Unemployment: "Covered", "Housing Security": "Covered", "Health Security": "Covered", Maternity: "Covered", Disability: "Covered", Survivors: "Covered" }) },
  { id: "national-self-employed", name: "National — Self-Employed",         detail: "Self-employed Emiratis under voluntary GPSSA enrolment.",                    populationLabel: "~0.05M", populationM: 0.05, cells: defaultCells({ "Retirement Coverage": "Voluntary", "Health Security": "Covered", Maternity: "Voluntary", Disability: "Voluntary", Survivors: "Voluntary" }) },
  { id: "national-informal",      name: "National — Informal Employment",   detail: "Emiratis in informal or uncovered work.",                                    populationLabel: "~0.02M", populationM: 0.02, cells: defaultCells({ "Health Security": "Limited" }) },
  { id: "expat-formal",           name: "Expat — Formal Employment",        detail: "Non-national private-sector workers (DEWS / EOSB regimes).",                 populationLabel: "~6.4M", populationM: 6.4, cells: defaultCells({ "Occupational Hazard": "Covered", Unemployment: "Limited", "Health Security": "Covered", Maternity: "Limited", Disability: "Limited", Survivors: "Limited" }) },
  { id: "expat-domestic",         name: "Expat — Domestic Workers",         detail: "Domestic workers under household sponsorship.",                              populationLabel: "~0.75M", populationM: 0.75, cells: defaultCells({ "Occupational Hazard": "Limited", "Health Security": "Covered", Maternity: "Limited" }) },
  { id: "expat-other",            name: "Expat — Other",                    detail: "Other non-national workers including informal cohorts.",                     populationLabel: "~1.4M", populationM: 1.4, cells: defaultCells({ "Health Security": "Limited" }) },
  { id: "gcc-mobile",             name: "GCC Mobile Workers",               detail: "GCC nationals posted to UAE under the GCC unified extension.",               populationLabel: "~0.05M", populationM: 0.05, cells: defaultCells({ "Retirement Coverage": "Covered", "Occupational Hazard": "Covered", Unemployment: "Limited", "Health Security": "Covered", Maternity: "Covered", Disability: "Covered", Survivors: "Covered" }) },
  { id: "military-security",      name: "Military & Security",              detail: "Armed forces & security personnel under dedicated military pension scheme.", populationLabel: "~0.1M", populationM: 0.1, cells: defaultCells({ "Retirement Coverage": "Covered", "Occupational Hazard": "Covered", "Housing Security": "Covered", "Health Security": "Covered", Maternity: "Covered", Disability: "Covered", Survivors: "Covered" }) },
];
